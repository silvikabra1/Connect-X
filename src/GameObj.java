 ...
 *
 * Game objects exist in the game court. They have a position, size and bounds. Their position 
 * should always be within their bounds.
 */
public abstract class GameObj {
     ...
     * Constructor
     */
    public GameObj(int px, int py, int width, int height, int boundWidth, int boundHeight) {
        this.px = px; 
        this.py = py;
        this.width  = width;
        this.height = height;
        ...
        // of the object.
        this.maxX = boundWidth - width;
        this.maxY = boundHeight - height;
    }
    ...
    /**
     * Moves the object one over based on direction. Ensures that object stays on screen
     */
     public void moveLeft() {
     if(this.px - Circle.BOUND > 0)
        this.px -= Circle.BOUND;
    }
     
     public void moveRight() {
     if(this.px + Circle.BOUND < GameBoard.getBoardWidth() - 1)
    	 this.px += Circle.BOUND;
     }
     
     public void moveDown() {
    	 if(this.py + Circle.BOUND < GameBoard.getBoardHeight() - 1)
    		 this.py += Circle.BOUND;
     }
